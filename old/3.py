...
def update_camera(window_size):
    ...
    max_offset_x = MAP_SIZE[0] * GRID_CELL_SIZE - window_size[0]
    max_offset_y = MAP_SIZE[1] * GRID_CELL_SIZE - window_size[1]

    camera_offset[0] = max(0, min(target_offset_x, max_offset_x))
    camera_offset[1] = max(0, min(target_offset_y, max_offset_y))
