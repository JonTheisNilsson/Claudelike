...
import pygame
import sys
from constants import INITIAL_WINDOW_SIZE, MOVE_DELAY
...
def main():
    ...
    continuous_move_delay = MOVE_DELAY // 2  # Faster movement when key is held down
    ...
    while True:
        ...
        if continuous_move and current_time - last_move_time >= continuous_move_delay:
